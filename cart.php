  ...
  ?>
    <div class="container">
      <div class="jumbotron">
        <h1>Shopping Cart</h1>
        <p>
          "Uh-oh! It looks like our shopping cart is feeling a bit hungry, and it's missing your delicious choices! Don't leave it empty—head back now and treat yourself to a feast. Your taste buds will thank you, and our cart will be overjoyed to carry the culinary delights straight to your doorstep. Let the foodie adventure begin!" <a href="foodlist.php">order now.</a></p>
